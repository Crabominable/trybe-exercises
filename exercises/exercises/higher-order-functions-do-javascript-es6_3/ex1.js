...
function fantasyOrScienceFiction(genre1, genre2) {
  // escreva seu código aqui
  return books.filter((book) => book.genre === genre1 || book.genre === genre2);
}

assert.deepStrictEqual(fantasyOrScienceFiction('Ficção Científica', 'Fantasia'), expectedResult);
